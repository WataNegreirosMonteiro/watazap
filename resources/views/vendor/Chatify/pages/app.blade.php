...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav>
                <a href="{{ url('/') }}"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">MENSAGENS</span> </a>
                {{-- header buttons --}}
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            ...
            <div class="internet-connection">
                ...
                <span class="ic-noInternet">Sem acesso a rede</span>
            </div>
        </div>
        ...
        <div class="m-body messages-container app-scroll">
            <div class="messages">
                <p class="message-hint center-el"><span>Selecione uma conversa para iniciar o papo</span></p>
            </div>
            {{-- Typing indicator --}}
